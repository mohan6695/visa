...
-- GROUPS TABLE (depends on nothing)
...
-- COMMUNITIES TABLE (depends on nothing)
...
-- VISA TYPES TABLE (depends on countries)
...
-- =============================================
-- TIER 3: Tables depending on Tier 1 & 2
-- =============================================

-- POSTS TABLE (depends on users, groups)
...
-- COMMENTS TABLE (depends on users, posts, communities)
...
-- COMMUNITY MEMBERS TABLE (depends on users, communities)
...
-- GROUP MEMBERS TABLE (depends on users, groups)
...
-- VISA REQUIREMENTS TABLE (depends on visa_types)
...
-- POST TAGS TABLE (depends on posts, tags)
...
-- =============================================
-- TIER 5: Interaction & Notification tables
-- =============================================
...
-- USER INTERACTIONS TABLE (depends on users)
...
-- POST LIKES TABLE (depends on users, posts)
...
-- COMMENT LIKES TABLE (depends on users, comments)
...
-- GROUP MESSAGES TABLE (depends on users, communities)
...
-- GROUP MESSAGE LIKES TABLE (depends on users, group_messages)
...
-- MESSAGE READ RECEIPTS TABLE (depends on users, communities, group_messages)
...
-- USER PRESENCE TABLE (depends on users, communities)
...
-- ANALYTICS EVENTS TABLE (depends on users)
