#!/usr/bin/env python3
"""
Supabase S3 Storage Uploader using AWS Signature V4
"""
...
def upload_file_to_supabase_s3(file_path, endpoint, access_key, secret_key, bucket, object_name):
    """
...
def main():
    ...
    # This looks like an S3 access key ID (visakey prefix) + secret (UUID)
    key_input = 'visakey:57cdc4296f52ea5078cbfdb138395166'
    
    # Split to get access key and secret
    # Format: access_key = 'visakey'
    ...
    result = upload_file_to_supabase_s3(file_path, endpoint, access_key, secret_key, bucket, object_name)
